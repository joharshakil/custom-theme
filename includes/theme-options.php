        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
				...
				?>
                    ...
                    <tr valign="top">
                        <th scope="row">
                            <?php _e( 'googleplus', 'sampletheme' ); ?>
                        </th>
                        <td>
                            <input id="cOptn[linkedin]" class="large-text" type="text" name="cOptn[linkedin]" value="<?php echo esc_textarea( $options['googleplus'] ); ?>">
                            <label class="description" for="cOptn[linkedin]"><?php _e( 'Please Enter linkedin link', 'sampletheme' ); ?></label>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">
                            <?php _e( 'linkedin', 'sampletheme' ); ?>
                        </th>
                        <td>
                    ...
                    <tr valign="top">
                        <th scope="row">
                            <?php _e( 'Get Request Qoute', 'sampletheme' ); ?>
                        </th>
                        <td>
